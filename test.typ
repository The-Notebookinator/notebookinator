...
#create-body-entry(
  title: lorem(2),
  type: "brainstorm",
  start-date: datetime(year: 2024, month: 1, day: 1),
)[
#grid(
  columns: (1fr, 1fr),
  gutter: 20pt,
...
#create-body-entry(
  title: lorem(1),
  type: "decide",
  start-date: datetime(year: 2024, month: 1, day: 2),
)[]
#create-body-entry(
  title: lorem(3),
  type: "program",
...
#create-body-entry(
  title: lorem(2),
  type: "identify",
  start-date: datetime(year: 2024, month: 1, day: 3),
)[]
#create-body-entry(
  title: lorem(5),
  type: "test",
...
#create-body-entry(
  title: lorem(1),
  type: "build",
  start-date: datetime(year: 2024, month: 1, day: 4),
)[]

#glossary.add-term("Bob", [#lorem(20)])
#glossary.add-term("Bob", [#lorem(20)])
#glossary.add-term("Bob", [#lorem(20)])
#glossary.add-term("Bob", [#lorem(20)])
#glossary.add-term("Bob", [#lorem(20)])
